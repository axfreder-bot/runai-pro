...
const STRAVA_PROXY = 'https://runai-pro-api.axfreder.workers.dev';
...
function connectStrava() {
  const redirectUri = encodeURIComponent('https://runai-pro-api.axfreder.workers.dev/api/strava/callback');
